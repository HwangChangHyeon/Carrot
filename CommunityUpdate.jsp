...
%>
  			<div class="write">
  				...
  				<div class="story">
  					<form method="post" action="CommunityControl.jsp?bbsID=<%=bbsID%>">
  					<input type="hidden" name="action" value="update">
  					<div class="form-group">
    						<label for="inputAddress2">제목</label>
  						</div>
  						 <div class="form-group">
   							 <input type="text" class="form-control" id="inputAddress2" name="bbsTitle" placeholder="제목을 입력하세요" value="<%=bbs.getBbsTitle()%>">
  						</div>
  						 <div class="form-group">
    						<label for="exampleFormControlTextarea1">내용</label>
 						</div>
  						<div class="form-group">
    						<textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="bbsContent" placeholder="내용을 입력하세요"><%=bbs.getBbsContent()%></textarea>
 						</div>
